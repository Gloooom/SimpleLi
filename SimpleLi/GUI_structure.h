...
private:
	Win_IndStat(DWORD _headCol, DWORD _backCol, DWORD _objsColor):
	   GUI_window(200, 120, "Individ Status", fnt, headCol, backCol, objsColor) {
		   ...
		   //—делать окошко, где бы отображалось нынешнее положение на поле, центрированное на особи
		   //там же добавить направление вектора движени€
...
//организовать ещЄ окно дл€ настройки отображени€
